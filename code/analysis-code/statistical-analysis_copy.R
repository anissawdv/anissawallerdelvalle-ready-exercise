...
###########
#### Third model fit, contributed by Anissa Waller Del Valle
# fit linear model using height as outcome and the 2 new variables, age and marital status, as predictors.

lmfit3 <- lm(Height ~ Age + `Marital Status`, mydata)
